...
We deployed our ["Seamless Stories" workflow](https://www.causalmap.app/resources/from-qualia-to-causal-map/)—an end-to-end, AI-supported process that combines [**QualiaInterviews**](https://www.qualiainterviews.com/) for data collection and[ **Causal Map**](https://www.causalmap.app/) for systematic analysis. This approach allowed the university to move from research questions to high-quality visual maps much faster than traditional manual coding, without sacrificing the nuance of the students’ lived experiences.
...
- **Sythesis:** The workflow transformed 32 in-depth interviews into manageable causal maps, making it easy to identify the most frequent factors mentioned by respondents.
...
![[Pasted image 20260115154359.png]]
